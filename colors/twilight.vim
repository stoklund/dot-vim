...
let s:mid_grey_blue = '#5f5a60'
let s:beige = '#cda869'
let s:light_orange = '#9b703f'
let s:yellow = '#f9ee98'
let s:violet = '#a999ac'
let s:green = '#8f9d6a'
...
exe 'hi ColorColumn                                   guibg='.s:grey            .' gui=none'
...
exe 'hi Structure      guifg='.s:yellow            .' guibg='.s:darkgrey        .' gui=none'
...
exe 'hi StorageClass   guifg='.s:yellow            .' guibg='.s:darkgrey        .' gui=none'
